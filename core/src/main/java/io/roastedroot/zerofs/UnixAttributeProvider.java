...
final class UnixAttributeProvider extends AttributeProvider {
    ...
    private static final Set<String> ATTRIBUTES =
            Set.of("uid", "ino", "dev", "nlink", "rdev", "ctime", "mode", "gid");
    ...
    // ID themselves and just get that rather than doing caching here. Then this could be a
    // singleton
    // like the rest of the AttributeProviders. However, that would require a way for the
    // owner/posix
